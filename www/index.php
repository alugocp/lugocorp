...
<html>
  <head>
    ...
    <meta name="description" content="A software publishing company for projects designed and/or built by Alex Lugo. Check out our products today">
    <meta name="keywords" content="lugocorp,software,lugo,alex lugo,software engineering,lugo corp,software">
  ...
  <body>
    ...
    <div class="welcome-wrapper">
      <div class="welcome">
        ...
        <p>
          Trying to build a better future, one project at a time
        </p>
      </div>
    </div>
      ...
      <div class="section" style="background-color:var(--gray1)">
        <div class="content">
          ...
          <p>
            ...
            Our mission is to create a more equitable, sustainable world and boost organizations with a similar mindset.
            The hope is that we can leave the planet in a slightly better state than when we were founded.
            We've provided web, mobile and cloud development for multiple organizations in the DMV area.
          </p>
          <p>
            We've trained both local and international programmers in various languages and frameworks to boost their confidence and coding abilities.
            You can view some of these past and present team members on the <a href="team">team page</a>.
            We no longer focus on contracting as a source of income, but you can still view our <a href="services/web">web development portfolio</a>.
          </p>
        </div>
      </div>
      ...
      <div class="section" style="background-color:var(--blue)">
        <div class="content">
          ...
          <div class="wrapper3 override-small">
            ...
            <div class="product">
              <img class="product-logo" src="res/products/budgie.svg">
              <h2>Budgie</h2>
              <p>
        ...
        <div class="content">
          <div class="partners">
            ...
            <div class="partners-wrapper">
              <img class="partner" src="res/partners/haystack.svg" title="Haystack Solutions">
              <img class="partner" src="res/partners/tavolo.png" title="Tavolo Solutions, LLC">
